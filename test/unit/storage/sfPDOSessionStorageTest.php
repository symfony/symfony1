...
$database->initialize(array('dsn' => 'sqlite::memory:'));
...
$storage = sfStorage::newInstance('sfPDOSessionStorage');
$storage->initialize(array('db_table' => 'session', 'session_id' => $session_id, 'database' => $database));
