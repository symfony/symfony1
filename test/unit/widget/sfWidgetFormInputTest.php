...
$t->is($w->render('foo', '', array('type' => 'password', 'class' => 'foobar')), '<input type="password" name="foo" class="foobar" id="foo" />', '->render() can take HTML attributes as its third argument');
