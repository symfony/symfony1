...
abstract class BaseBookPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (BookPeer::ID, BookPeer::NAME, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (BookPeer::ID => 0, BookPeer::NAME => 1, ),
	...
	public static function doCount(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$rs = BookPeer::doSelectRS($criteria, $con);
		if ($rs->next()) {
			return $rs->getInt(1);
		} else {
						return 0;
	...
	{
		return BookPeer::populateObjects(BookPeer::doSelectRS($criteria, $con));
	}
	...
	public static function doDeleteAll($con = null)
	{
	 ...
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			$criteria = clone $values; 		} elseif ($values instanceof Book) {
