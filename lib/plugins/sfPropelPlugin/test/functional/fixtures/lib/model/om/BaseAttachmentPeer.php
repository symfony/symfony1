...
abstract class BaseAttachmentPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (AttachmentPeer::ID, AttachmentPeer::NAME, AttachmentPeer::FILE, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (AttachmentPeer::ID => 0, AttachmentPeer::NAME => 1, AttachmentPeer::FILE => 2, ),
	...
	{
		return BasePeer::getMapBuilder('lib.model.map.AttachmentMapBuilder');
	}
	
	public static function getPhpNameMap()
	{
		if (self::$phpNameMap === null) {
			$map = AttachmentPeer::getTableMap();
	...
	const COUNT = 'COUNT(attachment.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT attachment.ID)';
	...
	public static function doCount(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		if ($distinct || in_array(Criteria::DISTINCT, $criteria->getSelectModifiers())) {
			$criteria->addSelectColumn(AttachmentPeer::COUNT_DISTINCT);
		} else {
			$criteria->addSelectColumn(AttachmentPeer::COUNT);
		}
		...
		$rs = AttachmentPeer::doSelectRS($criteria, $con);
		if ($rs->next()) {
			return $rs->getInt(1);
		} else {
						return 0;
	...
	{
		return AttachmentPeer::populateObjects(AttachmentPeer::doSelectRS($criteria, $con));
	}
  ...
  static public function getUniqueColumnNames()
  {
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(AttachmentPeer::ID); 
	...
	public static function doDeleteAll($con = null)
	{
	 ...
	 {
		if ($con === null) {
			$con = Propel::getConnection(AttachmentPeer::DATABASE_NAME);
		}

		if ($values instanceof Criteria) {
			$criteria = clone $values; 		} elseif ($values instanceof Attachment) {
...
if (Propel::isInit()) {
			try {
		BaseAttachmentPeer::getMapBuilder();
	} catch (Exception $e) {
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
	}
} else {
			Propel::registerMapBuilder('lib.model.map.AttachmentMapBuilder');
}
