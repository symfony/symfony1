...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/tmp/symfony-for-release/1.1.0/lib/plugins/sfPropelPlugin/test/functional/fixtures/log/backend_test.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/tmp/symfony-for-release/1.1.0/lib/plugins/sfPropelPlugin/test/functional/fixtures/cache/backend/test/i18n',
  'lifetime' => 31556926,
  'prefix' => '/tmp/symfony-for-release/1.1.0/lib/plugins/sfPropelPlugin/test/functional/fixtures/apps/backend/i18n',
));
  ...
  $class = sfConfig::get('sf_factory_routing', 'sfPatternRouting');
      $cache = new sfFileCache(array (
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/tmp/symfony-for-release/1.1.0/lib/plugins/sfPropelPlugin/test/functional/fixtures/cache/backend/test/config/routing',
  'lifetime' => 31556926,
  'prefix' => '/tmp/symfony-for-release/1.1.0/lib/plugins/sfPropelPlugin/test/functional/fixtures/apps/backend/routing',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'session_path' => '/tmp/symfony-for-release/1.1.0/lib/plugins/sfPropelPlugin/test/functional/fixtures/cache/backend/test/test/sessions',
))));
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/tmp/symfony-for-release/1.1.0/lib/plugins/sfPropelPlugin/test/functional/fixtures/cache/backend/test/template',
  'lifetime' => 86400,
  'prefix' => '/tmp/symfony-for-release/1.1.0/lib/plugins/sfPropelPlugin/test/functional/fixtures/apps/backend/template',
)));
