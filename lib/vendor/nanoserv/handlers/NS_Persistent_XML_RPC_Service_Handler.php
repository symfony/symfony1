...
/**
 *
 * nanoserv handlers - Persistent XML-RPC service handler
 * 
...
/**
 * Persistent XML-RPC service handler class
 *
 * @package nanoserv
 * @subpackage Handlers
 */
class NS_Persistent_XML_RPC_Service_Handler extends NS_XML_RPC_Service_Handler {
	...
	/**
	 * Persistent XML-RPC service handler constructor
	 *
	 * @param object $o
	 */
