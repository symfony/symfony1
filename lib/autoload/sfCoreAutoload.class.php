...
class sfCoreAutoload
{
  ...
  protected $classes = array(
    ...
    'sfevent' => 'event/sfEvent.php',
    'sfeventdispatcher' => 'event/sfEventDispatcher.php',
    ...
    'sfconfiguredatabasetask' => 'task/configure/sfConfigureDatabaseTask.class.php',
    ...
    'sfprojectfreezetask' => 'task/project/sfProjectFreezeTask.class.php',
    'sfprojectpermissionstask' => 'task/project/sfProjectPermissionsTask.class.php',
    'sfprojectunfreezetask' => 'task/project/sfProjectUnfreezeTask.class.php',
    'sfupgradeto11task' => 'task/project/sfUpgradeTo11Task.class.php',
    'sfupgradeto12task' => 'task/project/sfUpgradeTo12Task.class.php',
    'sfupgradeto13task' => 'task/project/sfUpgradeTo13Task.class.php',
    'sfcomponentupgrade' => 'task/project/upgrade1.1/sfComponentUpgrade.class.php',
    'sfconfigfileupgrade' => 'task/project/upgrade1.1/sfConfigFileUpgrade.class.php',
    'sfconfigupgrade' => 'task/project/upgrade1.1/sfConfigUpgrade.class.php',
    'sfenvironmentupgrade' => 'task/project/upgrade1.1/sfEnvironmentUpgrade.class.php',
    'sffactoriesupgrade' => 'task/project/upgrade1.1/sfFactoriesUpgrade.class.php',
    'sfflashupgrade' => 'task/project/upgrade1.1/sfFlashUpgrade.class.php',
    'sflayoutupgrade' => 'task/project/upgrade1.1/sfLayoutUpgrade.class.php',
    'sfloggerupgrade' => 'task/project/upgrade1.1/sfLoggerUpgrade.class.php',
    'sfpropelupgrade' => 'task/project/upgrade1.1/sfPropelUpgrade.class.php',
    'sfsettingsupgrade' => 'task/project/upgrade1.1/sfSettingsUpgrade.class.php',
    'sfsingletonupgrade' => 'task/project/upgrade1.1/sfSingletonUpgrade.class.php',
    'sftestupgrade' => 'task/project/upgrade1.1/sfTestUpgrade.class.php',
    'sfupgrade' => 'task/project/upgrade1.1/sfUpgrade.class.php',
    'sfviewcachemanagerupgrade' => 'task/project/upgrade1.1/sfViewCacheManagerUpgrade.class.php',
    'sfwebdebugupgrade' => 'task/project/upgrade1.1/sfWebDebugUpgrade.class.php',
    'sfconfigurationupgrade' => 'task/project/upgrade1.2/sfConfigurationUpgrade.class.php',
    'sffactories12upgrade' => 'task/project/upgrade1.2/sfFactories12Upgrade.class.php',
    'sfpluginassetsupgrade' => 'task/project/upgrade1.2/sfPluginAssetsUpgrade.class.php',
    'sfpropel13upgrade' => 'task/project/upgrade1.2/sfPropel13Upgrade.class.php',
    'sfpropeliniupgrade' => 'task/project/upgrade1.2/sfPropelIniUpgrade.class.php',
